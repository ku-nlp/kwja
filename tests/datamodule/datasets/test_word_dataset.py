...
def test_init(path: Path, tokenizer: PreTrainedTokenizerBase, dataset_kwargs: Dict[str, Any]):
    _ = WordDataset(str(path), tokenizer, max_seq_length=256, document_split_stride=1, **dataset_kwargs)
